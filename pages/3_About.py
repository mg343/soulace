...
st.write("SoulAce was developed with the vision of a resource capable of allowing those struggling with mental health problem to get access to tools that would have previously been chalenging to come by.")
